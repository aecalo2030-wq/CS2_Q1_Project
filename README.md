...
- Support for discounts, sales tax, and data saving.
...
4. Open the program file ("Sales_tracker") in VS Code or your IDE of choice.  
5. Run the program:
...
7. File Structure:
   ...
   - inventory.json: This is where the data of your main program is stored. This is basically the data base.
...
ITEM NAME       | PRICE     | Category   | SOLD   | STOCK    | SALES      

Coke            | PHP 25.00    | Drinks   | 2      | 8        | PHP 50.00     
TOTAL REVENUE: PHP 50.00
